 ...
 *
 *  @name Custom Indexes Pagination
 *  @summary Muestra los botones Anterior, Siguiente, Primero, Último y una lista de botónes con índices personalizados.
 *  @author [Diego Miguel Angel López Muñoz]
 *
 *  @example
 *    $(document).ready(function() {
 *        $('#example').dataTable( {
 *            "sPaginationType": "custom_indexes"
 *        } );
 *    } );
 */

$.fn.dataTableExt.oPagination.custom_indexes = {
