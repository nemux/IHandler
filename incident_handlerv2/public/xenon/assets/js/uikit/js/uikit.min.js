...
!function (a) {
    ...
    if (d.version = "2.10.0", d.$doc = g, d.$win = f, d.fn = function (a, c) {
            ...
            setInterval(function () {
                var a = {x: window.pageXOffset, y: window.pageYOffset}, c = function () {
                    (a.x != window.pageXOffset || a.y != window.pageYOffset) && (a = {
                        x: window.pageXOffset,
                        y: window.pageYOffset
                    }, g.trigger("uk-scroll", [a]))
                };
    ...
    b.components = {}, b.component = function (c, d) {
        ...
        return e.plugins = {}, a.extend(!0, e.prototype, {
    ...
    "use strict";
    var c, d = !1;
    b.component("dropdown", {
        defaults: {mode: "hover", remaintime: 800, justify: !1, boundary: b.$win, delay: 0},
        remainIdle: !1,
        init: function () {
            var e = this;
    ...
    b.component("modal", {
        ...
        show: function () {
            if (!this.isActive())return e && e.hide(!0), this.element.removeClass("uk-open").show(), this.resize(), e = this, f.addClass("uk-modal-page").height(), this.element.addClass("uk-open").trigger("uk.modal.show"), b.Utils.checkDisplay(this.dialog), this
        },
        hide: function (a) {
            if (this.isActive()) {
        ...
        b.modal.dialog(['<div class="uk-margin uk-modal-content">' + String(c) + "</div>", '<div class="uk-modal-buttons"><button class="uk-button uk-button-primary uk-modal-close">Ok</button></div>'].join(""), a.extend({
            bgclose: !1,
            keyboard: !1
        }, d)).show()
        ...
        var f = b.modal.dialog(['<div class="uk-margin uk-modal-content">' + String(c) + "</div>", '<div class="uk-modal-buttons"><button class="uk-button uk-button-primary js-modal-confirm">Ok</button> <button class="uk-button uk-modal-close">Cancel</button></div>'].join(""), a.extend({
            bgclose: !1,
            keyboard: !1
        }, e));
    ...
    "use strict";
    var c = {x: window.scrollX, y: window.scrollY}, d = b.$win, e = b.$doc, f = a("html"), g = {
        show: function (b) {
            if (b = a(b), b.length) {
                ...
                c = {
                    x: window.pageXOffset,
                    y: window.pageYOffset
                }, b.addClass("uk-active"), h.css({
                    width: window.innerWidth,
                    height: d.height()
                }).addClass("uk-offcanvas-page"), h.css(j ? "margin-right" : "margin-left", (j ? -1 : 1) * i.outerWidth() * l).width(), f.css("margin-top", -1 * c.y), i.addClass("uk-offcanvas-bar-show"), b.off(".ukoffcanvas").on("click.ukoffcanvas swipeRight.ukoffcanvas swipeLeft.ukoffcanvas", function (b) {
                    var c = a(b.target);
            ...
            var d = a("body"), g = a(".uk-offcanvas.uk-active"), h = "right" == a.UIkit.langdirection, i = g.find(".uk-offcanvas-bar:first"), j = function () {
                d.removeClass("uk-offcanvas-page").css({
                    ...
                    "margin-left": "",
                    "margin-right": ""
                }), g.removeClass("uk-active"), i.removeClass("uk-offcanvas-bar-show"), f.css("margin-top", ""), window.scrollTo(c.x, c.y), e.trigger("uk.offcanvas.hide", [g, i])
            };
    ...
    b.component("tooltip", {
        defaults: {
            ...
            var b = this;
            d || (d = a('<div class="uk-tooltip"></div>').appendTo("body")), this.on({
                focus: function () {
                    b.show()
                }, blur: function () {
                    b.hide()
            ...
            if (e && clearTimeout(e), f && clearTimeout(f), this.tip.length) {
                ...
                }), g = d[0].offsetWidth, h = d[0].offsetHeight, i = "function" == typeof this.options.offset ? this.options.offset.call(this.element) : this.options.offset, j = "function" == typeof this.options.pos ? this.options.pos.call(this.element) : this.options.pos, k = j.split("-"), l = {
                    display: "none",
                    visibility: "visible",
                ...
                var p = {
                    bottom: {top: c.top + c.height + i, left: c.left + c.width / 2 - g / 2},
                    top: {top: c.top - h - i, left: c.left + c.width / 2 - g / 2},
                    left: {top: c.top + c.height / 2 - h / 2, left: c.left - g - i},
                    right: {top: c.top + c.height / 2 - h / 2, left: c.left + c.width + i}
                };
                ...
                l.left -= a("body").position().left, e = setTimeout(function () {
                    d.css(l).attr("class", ["uk-tooltip", "uk-tooltip-" + j, b.options.cls].join(" ")), b.options.animation ? d.css({
                        opacity: 0,
                        display: "block"
                    }).animate({opacity: 1}, parseInt(b.options.animation, 10) || 400) : d.show(), e = !1, f = setInterval(function () {
    ...
    "use strict";
    b.component("switcher", {
        defaults: {connect: !1, toggle: ">*", active: 0}, init: function () {
            var b = this;
    ...
    "use strict";
    b.component("tab", {
        defaults: {target: ">li:not(.uk-tab-responsive, .uk-disabled)", connect: !1, active: 0}, init: function () {
            var c = this;
            ...
            }), this.element.append(this.responsivetab), this.options.connect && b.switcher(this.element, {
                toggle: ">li:not(.uk-tab-responsive)",
                connect: this.options.connect,
                active: this.options.active
            }), b.dropdown(this.responsivetab, {mode: "click"}), c.trigger("uk.tab.change", [this.element.find(this.options.target).filter(".uk-active")]), this.check(), b.$win.on("resize orientationchange", b.Utils.debounce(function () {
                c.check()
            }, 100))
        }, check: function () {
            ...
            if (!(b.length < 2)) {
                ...
                if (this.responsivetab.lst.empty(), b.each(function () {
                    ...
                    }), f)for (var g = 0; g < b.length; g++)c = b.eq(g), d = c.find("a"), "none" == c.css("float") || c.attr("uk-dropdown") || (c.addClass("uk-hidden"), c.hasClass("uk-disabled") || this.responsivetab.lst.append('<li><a href="' + d.attr("href") + '" data-index="' + g + '">' + d.html() + "</a></li>"));
    ...
    var d = [];
    c.component("toggle", {
        defaults: {target: !1, cls: "uk-hidden"}, init: function () {
            var a = this;
