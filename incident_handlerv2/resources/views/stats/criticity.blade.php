...
@section('title', 'Estadísticas de Incidentes por Criticidad (Severidad)')
...
@section('include_down')
    <script type="text/javascript">
        ...
        var Graph = {
            make: function () {
                $.ajax({
                    url: '{{route('stats.criticity.post')}}',
                    method: 'post',
                    dataType: 'json',
                    data: {
                    ...
                    success: function (response) {
                        ...
                        options.title = {text: 'Incidentes por Criticidad (Severidad) del ' + $('#from_date').val() + ' al ' + $('#to_date').val()};
...
@section('dashboard_content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Estadísticas de Incidentes por Criticidad (Severidad)</h3>
        </div>
