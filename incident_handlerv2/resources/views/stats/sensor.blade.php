...
@section('title', 'Estadísticas de Incidentes por Sensor')
            ...
            make: function () {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        options.title = {text: 'Incidentes por Sensor del ' + $('#from_date').val() + ' al ' + $('#to_date').val()};
...
@section('dashboard_content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Estadísticas de Incidentes por Sensor</h3>
        </div>
