            ...
            <table>
                ...
                <tr style="">
                    <td rowspan="<?php echo count($incident->extraCategory) + 2; ?>"
                        style="text-align:center;background:#d9d9d9">
                ...
                <tr>
                    ...
                    <td colspan="2" style="text-align:center" width="100%">
                        ...
                        @foreach($incident->incidentSignatures as $s)
                            {{cleanContent($s->signature->signature)}}<br>
                        @endforeach
                    </td>
                </tr>
                <tr>
                    ...
                    <div class="form-group">
                        <table style="table-layout: fixed;">
                            <tr style="text-align:center;background:#CCC;">
                                <td colspan="2">
                                    <strong> Anexo: {{ cleanContent($a->title) }}
                                        Incidente: {{ isset($incident->ticket->internal_number) ? $incident->ticket->internal_number : "Por asignar..."  }}</strong>
                                </td>
                            </tr>
                            <tr>
