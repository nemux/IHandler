                                ...
                                <td colspan="6">
                                    <table id="category_table" class="table table-bordered" style="width:100%">
                                        ...
                                        <tr width='100%'>
                                            ...
                                            <td width='30%'>
                                                <a class="btn btn-default" onclick="genericRemove($(this))"
                                                   style="width:100%">Quitar</a>
                                            </td>
                                        </tr>
                                        <?php endforeach ?>
                                        <?php endif ?>
                            ...
                            <tr <?php echo $display_form ?>>
                                ...
                                <td>
                                    <select name="criticity" class="form-control">
                                        ...
                                        <option <?php if (isset($update) && $incident->criticity == 'BAJA') {
                                            echo "selected";
                                        } ?> value="BAJA">BAJA
                                        </option>
                                        <option <?php if (isset($update) && $incident->criticity == 'MEDIA') {
                                            echo "selected";
                                        } ?> value="MEDIA">MEDIA
                                        </option>
                                        <option <?php if (isset($update) && $incident->criticity == 'ALTA') {
                                            echo "selected";
                                        } ?> value="ALTA">ALTA
                                        </option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td width="35%">
                                    <div class="input-group bootstrap-timepicker">
                                        ...
                                        <?php if (!isset($update)) { ?>
                                        <input name="det_date" type="text" class="form-control " id="det_date"
                                               placeholder="Select Date" value="<?php echo date('Y-m-d H:i:s') ?>"/>

                                        <?php
                                        }else{ ?>
                                        <input name="det_date" type="text" class="form-control " id="det_date"
                                               placeholder="Select Date"
                                               value="<?php echo date('Y-m-d H:i:s', strtotime($det_time->datetime)) ?>"/>
                                        <?php } ?>
                                ...
                                <td width="35%">
                                    <div class="input-group bootstrap-timepicker">
                                        <?php if (!isset($update)) {
                                        ?>
                                        <input name="occ_date" type="text" class="form-control " id="occ_date"
                                               placeholder="Select Date" value="<?php echo date('Y-m-d H:i:s') ?>"/>
                                        ...
                                        <input name="occ_date" type="text" class="form-control " id="occ_date"
                                               placeholder="Select Date"
                                               value="<?php echo date('Y-m-d H:i:s', strtotime($occ_time->datetime)) ?>"/>
                                        <?php } ?>
                                        <span class="input-group-addon"><i class="fa fa-calendar-o"></i></span>
                                    </div>
                                </td>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr <?php echo $display_form ?>>
                                <td style="width:10%"><br>
                                    ...
                                    <a onclick="addEvent()" style="width:100%" class="btn btn-sm btn-success"><i
                                ...
                                <td colspan="4">
                                    <table class="table table-bordered table-striped ">
                                        ...
                                        <tr>
                                            <td>
                                                <input id="src_ip" type="text" class="form-control" name="search_src_ip"
                                                       placeholder="origen"><br>
                                                <input id="dst_ip" type="text" class="form-control" name="search_dst_ip"
                                                       placeholder="destino">
                                            </td>
                                            <td>
                                                <select id="src_location" type="text" class="form-control"
                                                        name="search_src_location">
                                                    ...
                                                    <option value="Ashmore andCartier Islands">Ashmore andCartier
                                                        Islands
                                                    </option>
                                                    ...
                                                    <option value="Islas Georgia del Sur y Sandwich del Sur">Islas
                                                        Georgia del Sur y Sandwich del Sur
                                                    </option>
                                                    <option value="Islas Heard y McDonald">Islas Heard y McDonald
                                                    </option>
                                                    <option value="Islas Malvinas">Islas Malvinas</option>
                                                    <option value="Islas Marianas del Norte">Islas Marianas del Norte
                                                    </option>
                                                    <option value="IslasMarshall">IslasMarshall</option>
                                                    <option value="Islas Pitcairn">Islas Pitcairn</option>
                                                    <option value="Islas Salomón">Islas Salomón</option>
                                                    <option value="Islas Turcas y Caicos">Islas Turcas y Caicos</option>
                                                    <option value="Islas Vírgenes Americanas">Islas Vírgenes
                                                        Americanas
                                                    </option>
                                                    <option value="Islas Vírgenes Británicas">Islas Vírgenes
                                                        Británicas
                                                    </option>
                                                    ...
                                                    <option value="TerritorioBritánicodel Océano Indico">
                                                        TerritorioBritánicodel Océano Indico
                                                    </option>
                                                    <option value="Territorios Australes Franceses">Territorios
                                                        Australes Franceses
                                                    </option>
                                                ...
                                                <br>
                                                <select id="dst_location" type="text" class="form-control"
                                                        name="search_dst_location">
                                                    <option value=" ">No especificado</option>
                                                    <option value="Local">Local</option>
                                                    <option value="Afganistán">Afganistán</option>
                                                    <option value="Akrotiri">Akrotiri</option>
                                            ...
                                            <td>
                                                <input id="src_blacklist" class="checkbox" type="checkbox"
                                                       name="search_src_blacklist" value="1"><br><br>
                                                <input id="dst_blacklist" class="checkbox" type="checkbox"
                                                       name="search_dst_blacklist" value="1">
                                            </td>
                                            <td>
                                                <input id="src_no_show" class="checkbox" type="checkbox"
                                                       name="search_src_no_show" value="1"><br><br>
                                                <input id="dst_no_show" class="checkbox" type="checkbox"
                                                       name="search_dst_no_show" value="1">
                                            </td>
                                            <td>
                                                <input id="src_port" type="text" class="form-control"
                                                       name="search_src_port" placeholder="origen"><br>
                                                <input id="dst_port" type="text" class="form-control"
                                                       name="search_dst_port" placeholder="destino">
                                            </td>
                                            <td>
                                                <input id="src_protocol" type="text" class="form-control"
                                                       name="search_src_protocol" placeholder="origen"><br>
                                                <input id="dst_protocol" type="text" class="form-control"
                                                       name="search_dst_protocol" placeholder="destino">
                                            </td>
                                            <td>
                                                <input id="src_operative_system" type="text" class="form-control"
                                                       name="search_src_operative_system" placeholder="origen"><br>
                                                <input id="dst_operative_system" type="text" class="form-control"
                                                       name="search_dst_operative_system" placeholder="destino">
                                            </td>
                                            <td>
                                                <input id="src_function" type="text" class="form-control"
                                                       name="search_src_function" placeholder="origen"><br>
                                                <input id="dst_function" type="text" class="form-control"
                                                       name="search_dst_function" placeholder="destino">
                                            </td>

                                        </tr>
                                        <tr>
                                            <td colspan="8" placeolder="Direcciones separadas con salto de línea">
                                                <textarea id="to_parse" name="nothing" class="form-control"
                                                          rows="5"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <a onclick="parse()" class="btn btn-default"
                                                   style="width:100%">Parse</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tr onclick="removeEvent(this)" style="cursor:pointer">
                                            ...
                                            <td style="display:none">
                                                <input style="display:none" type="text" class="form-control"
                                                       name="srcip_<?php echo $i ?>" placeholder="origen"
                                                       value="<?php echo $io->src->ip ?>"><br>
                                                <input style="display:none" type="text" class="form-control"
                                                       name="dstip_<?php echo $i ?>" placeholder="destino"
                                                       value="<?php echo $io->dst->ip ?>">
                                                <input style="display:none" type="text" class="form-control"
                                                       name="srcport_<?php echo $i ?>" placeholder="origen"
                                                       value="<?php echo $io->src->port ?>"><br>
                                                <input style="display:none" type="text" class="form-control"
                                                       name="dstport_<?php echo $i ?>" placeholder="destino"
                                                       value="<?php echo $io->dst->port ?>">
                                                <input style="display:none" type="text" class="form-control"
                                                       name="srcprotocol_<?php echo $i ?>" placeholder="origen"
                                                       value="<?php echo $io->src->protocol ?>"><br>
                                                <input style="display:none" type="text" class="form-control"
                                                       name="dstprotocol_<?php echo $i ?>" placeholder="destino"
                                                       value="<?php echo $io->dst->protocol ?>">
                                                <input style="display:none" type="text" class="form-control"
                                                       name="srcoperativesystem_<?php echo $i ?>" placeholder="origen"
                                                       value="<?php echo $io->src->operative_system ?>"><br>
                                                <input style="display:none" type="text" class="form-control"
                                                       name="dstoperativesystem_<?php echo $i ?>" placeholder="destino"
                                                       value="<?php echo $io->dst->operative_system ?>">
                                                <input style="display:none" type="text" class="form-control"
                                                       name="srcfunction_<?php echo $i ?>" placeholder="origen"
                                                       value="<?php echo $io->src->function ?>"><br>
                                                <input style="display:none" type="text" class="form-control"
                                                       name="dstfunction_<?php echo $i ?>" placeholder="destino"
                                                       value="<?php echo $io->dst->function ?>">
                                                <input style="display:none" type="text" class="form-control"
                                                       name="srclocation_<?php echo $i ?>" placeholder="origen"
                                                       value="<?php echo $io->src->location ?>"><br>
                                                <input style="display:none" type="text" class="form-control"
                                                       name="dstlocation_<?php echo $i ?>" placeholder="destino"
                                                       value="<?php echo $io->dst->location ?>">
                                                <input style="display:none" type="text" class="form-control"
                                                       name="srcoccurencestype_<?php echo $i ?>" placeholder="origen"
                                                       value="<?php echo $io->src->type->id ?>">
                                                <input style="display:none" type="text" class="form-control"
                                                       name="dstoccurencestype_<?php echo $i ?>" placeholder="destino"
                                                       value="<?php echo $io->dst->type->id ?>">
                                                <input style="display:none" type="text" class="form-control"
                        ...
                        <div class="form-group" style="">
                            <table class="table">
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <a name="button" class="btn btn-primary" onclick="$('#images').click()">Seleccionar
                                            archivos</a>
                                        <input class="btn btn-default" type="file" id="images" name="images[]"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="col-lg-12" style="padding-bottom:50px">.
                                            ...
                                            <div class="col-lg-4">
                                                <div class="col-lg-10">
                                                    <a href="/files/evidence/<?php echo $i->name ?>" target="blank"><i
                                                ...
                                                <div class="col-lg-2">
                                                    <i class="fa fa-minus-circle"
                                                       onclick="delFile('<?php echo $i->name ?>',$(this))"></i>
                                                </div>
                                            </div>
                                            <?php endif ?>
                                            <?php endforeach ?>
    ...
    <div class="modal fade" id="modal-dialog3">
        <div class="modal-dialog">
            <div class="modal-content" width="">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Error al ingresar la Regla de Detección</h4>
                </div>
                <div class="modal-body">
                    <div class="table-responsive">
                        <p>No es posible ingresar la regla, los campos Indicador y SID no pueden estar vacíos.</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal">Close</a>
