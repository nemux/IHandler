    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Lista de incidentes</h4>
            </div>
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" action="/incident/view/sensor" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-lg-2">
                            <div class="input-group">
                                ...
                                <select id="customer" name="customer" class="form-control" onchange="get_sensor()">
                        ...
                        <div class="col-lg-2">
                        <div class="form-group">
                            <select id="sensor_id" name="sensor_id" class="form-control"/></select>
                        </div></div>
                        <div class="col-lg-2">
                            <div class="input-group">
                                <input type="submit" class="btn btn-default" id="generate" name="generate" value="Generar Lista"/>
                            </div>
                        </div>
                    </div>
                </form>
