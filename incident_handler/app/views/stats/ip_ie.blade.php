...
@section('content')
    ...
    <head>
        ...
        <script charset="utf-8">
            function graph(start, end, customer, sensor, ip_type) {
                console.log('on click graph');
                $.ajax({
                    type: "POST",
                    url: "/stats/ip/ie/graph",
                    data: {
                        start: start,
                        end: end,
                        customer: customer,
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Incidentes por IP Interna o Externa</h4>
            </div>
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <select id="tipo_ip" class="form-control">
                                    <?php $ip_types = OccurenceType::all(); ?>
                                    <?php foreach($ip_types as $ipt): ?>
                                    <option value="<?php echo $ipt->id ?>"><?php echo $ipt->name ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
